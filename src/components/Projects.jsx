  ...
  return (
    <div className="py-8 mx-auto max-w-xl lg:max-w-full lg:py-12">
      <div className="sm:flex justify-between mb-8 sm:mb-12">
        <h1 className="font-black text-2xl leading-none tracking-tight text-gray-900 pb-8 lg:text-3xl sm:pb-0">
          Proyectos
        </h1>
          ...
          {portfolio.usedCategories.map((filter, index) => {
            ...
            return (
              ...
              >
                ...
                />
                <div className="bg-white border-2 rounded-md border-blue-400 w-7 h-7 flex flex-shrink-0 justify-center items-center mr-2 focus-within:border-blue-500">
                  <svg
